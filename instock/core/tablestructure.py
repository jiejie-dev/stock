...
TABLE_CN_STOCK_ATTENTION = {
    ...
    "cn": "我的关注",
    "columns": {
        "datetime": {"type": DATETIME, "cn": "日期", "size": 0},
...
TABLE_CN_STOCK_BACKTEST_DATA = {
    ...
    "cn": "股票回归测试数据",
    "columns": {
        "rate_%s" % i: {"type": FLOAT, "cn": "%s日收益率" % i, "size": 100}
        for i in range(1, RATE_FIELDS_COUNT + 1, 1)
    },
}
...
TABLE_CN_STOCK_SELECTION = {
    ...
    "columns": {
        ...
        "concept": {
            "type": VARCHAR(800, _COLLATE),
            "cn": "概念",
            "size": 150,
            "map": "CONCEPT",
        },
        "style": {
            "type": VARCHAR(255, _COLLATE),
            "cn": "板块",
            "size": 150,
            "map": "STYLE",
        },
        "is_hs300": {
            "type": VARCHAR(2, _COLLATE),
            "cn": "沪300",
            "size": 0,
            "map": "IS_HS300",
        },
...
CN_STOCK_CPBD = {
    ...
    "cn": "操盘必读",
    "columns": {
        "SECURITY_CODE": {"type": VARCHAR(6, _COLLATE), "cn": "代码"},
